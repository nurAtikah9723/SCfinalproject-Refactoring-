...
public class Loan 
{
	...
	public void returnBookcs(Borrower borrower, Staff staff) {
		getBook().setIssuedStatus(false);
		setReturnedDate(new Date());
		setReceiver(staff);
		borrower.removeBorrowedBook(this);
		payFine();
		System.out.println(
				"\nThe book " + getBook().getTitle() + " is successfully returned by " + borrower.getName() + ".");
